      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            _StrengthRow(exerciseId: 'barbell-bench-press', title: 'Жим лёжа'),
            const SizedBox(height: 8),
            _StrengthRow(exerciseId: 'barbell-full-squat', title: 'Присед'),
            const SizedBox(height: 8),
            _StrengthRow(exerciseId: 'barbell-deadlift', title: 'Становая'),
          ],
        ),
      ),
    );
