                              ...
                              child: Column(
                                children: [
                                  ...
                                  _row(context, Icons.timer_outlined,
                                      'Продолжительность', plan.durationLabel),
                                  const Divider(height: AppSpacing.lg),
                                  _row(
                                      context,
                                  ...
                                  _row(
                                      ...
                                      'Вода',
                                      '${(plan.waterMl / 1000).toStringAsFixed(1)} л'),
                                ],
                              ),
                            ),
                          ),
                            ...
                            child: AppCard(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      _macro(context, 'Белки', plan.protein,
                                          AppColors.protein),
                                      _macro(context, 'Жиры', plan.fat,
                                          AppColors.fat),
                                      _macro(context, 'Углеводы', plan.carbs,
                                          AppColors.carbs),
                                    ],
                                  ),
                                ],
